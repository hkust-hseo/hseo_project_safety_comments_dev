...
/* Form handling */
  ...
  echo '<html><head><link rel = "stylesheet" type = "text/css" href = "css/universal.css"><link rel = "stylesheet" type = "text/css" href = "../css/new_proj.css"><header>New Project<a href = "http://143.89.148.116/hseo_project_safety_comments_dev"><img src = "img/hkust_logo_white.png"/></a></header></head><body>';
